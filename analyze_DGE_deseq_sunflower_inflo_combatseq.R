...
png("plots/sequential_pairwise_upset_cs.png", res=215, width = 1200, height=1000)
upset(fromList(SigOverlapGraph_pairwise_cs),order.by="freq",nsets=13,nintersects=20)
dev.off()
...
png("plots/sequential_pairwise_upset_lrt.png", res=215, width = 1200, height=1000)
